...
public class SellerFormController implements Initializable {
	...
	private DepartmentService departmentService; // dependencia com a tabela de departamentos
	...
	public void setServices(SellerService service, DepartmentService departmentService) {// dependencia
	...
	private Seller getFormData() {
		...
		if (dpBirthDate.getValue() == null) {
			exception.addError("bithDate", "Campo nao pode ser vazio");
		} else {
	...
	public void loadAssociatedObjects() {
		...
		comboBoxDepartment.setItems(obsList);// carregar lista de departamentos na comboBox;
	}
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		//operção ternaria para diminuir os if's
